...
(function () {
  function OpenMPTGenerator(urlOrData, audioCtx, playerOpts, trackOpts) {
    ...
    function initModule(data) {
      ...
      modulePtr = libopenmpt._openmpt_module_create_from_memory(
        ptrToFile,
      ...
      libopenmpt._openmpt_module_ctl_set(
        ...
        asciiToStack("1")
      ); // enable Amiga resampler
      libopenmpt._openmpt_module_ctl_set(
        modulePtr,
        asciiToStack("render.resampler.emulate_amiga_type"),
        asciiToStack("a1200")
      ); // set emulated Amiga model to A1200
      stackRestore(stack);

      self.duration =
        libopenmpt._openmpt_module_get_duration_seconds(modulePtr);
    }
    ...
    this.load = function (onReady) {
      ...
      function loadFromURL() {
        ...
        /* trigger XHR */
        request.open("GET", urlOrData, true);
      ...
      function loadFromData() {
        ...
        initModule(urlOrData);
        onReady();
      }

      if (typeof urlOrData === "string") {
        ensureLibOpenMPT(loadFromURL);
      } else {
        ensureLibOpenMPT(loadFromData);
      }
    };
